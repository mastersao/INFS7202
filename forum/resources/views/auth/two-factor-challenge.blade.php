                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('two-factor-challenge') }}">
                            ...
                            <div class="form-group row">
                                <label for="code" class="col-md-4 col-form-label text-md-right">{{ __('Authentication
                                    code:') }}</label>
                ...
                <div class="mt-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('two-factor-challenge') }}">
                            ...
                            <div class="form-group row">
                                <label for="recovery_code" class="col-md-4 col-form-label text-md-right">{{ __('Recovery
                                    Code:') }}</label>
